...
<head>
    ...
    *{
    ...
    .home{
        display: flex;
        background: url("https://img.freepik.com/premium-photo/close-up-wooden-gavel-computer-keyboard_253401-209.jpg?w=900") no-repeat center;
        height: 100vh;
        color: #fff;
        min-height: 500px;
     ...
     <div class="max-width">
         ...
         <ul class="menu">
            ...
            <li><a href="#contact" class="menu-btn">Contact&nbsp;&nbsp;&nbsp;</a></li>
             <li id="login-dropdown" class="menu-btn dropdown-container">
             <li><a href="login" class="menu-btn">Login/Register</a></li>
             </li>
         </ul>
         <div class="menu-btn">
        ...
        <div class="max-width">
            ...
            <div class="about-content">
                <div class="column left">
                    <img src="https://img.freepik.com/free-vector/gadgets-auction_1284-22060.jpg?size=626&ext=jpg&ga=GA1.1.1126628469.1697196915&semt=ais" alt="img">
                </div>
                <div class="column right">
                    <div class="text">Online Bidding System<span class="typing-2"></span></div>
                    <p> An online bidding system is a digital platform that facilitates the process of auctioning goods or services over the internet. It allows participants from different locations to place bids on items of interest, often competing in real-time against one another. Such systems are designed to provide a transparent, efficient, and accessible way for buyers and sellers to engage in competitive pricing.</p>
                </div>
            </div>
        </div>
    </section>
